# -*- coding: utf-8 -*-
"""Test runner for scene_002 - Director/Predictor/Performer APIs"""
...
OUTPUT_DIR = r"C:\Users\20731\.openclaw\workspace\logic\test_logs\2026-02-26\run_002"
TEST_INPUT = os.path.join(OUTPUT_DIR, "test_input.json")
...
if __name__ == "__main__":
    print("=" * 60)
    print("Running test scenario: scene_002 (negative)")
    print("=" * 60)
    ...
    axes_data = test_input.get('axes_before', {})
