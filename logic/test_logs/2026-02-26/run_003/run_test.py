# -*- coding: utf-8 -*-
"""Test runner for scene_003 - cold start scenario"""
...
OUTPUT_DIR = r"C:\Users\20731\.openclaw\workspace\logic\test_logs\2026-02-26\run_003"
INPUT_FILE = r"C:\Users\20731\.openclaw\workspace\logic\test_logs\2026-02-26\run_003\test_input.json"
...
if __name__ == "__main__":
    print("=" * 60)
    print("Running test scenario: scene_003 (cold)")
    print("=" * 60)
    ...
    character_axes = character.get('axes', {})
    
    # Override axes with test_input values
    axes_data = test_input.get('axes_before', character_axes)
    user_input = test_input.get('user_input', '嗯')
    scene_type = test_input.get('scene_type', 'cold')
    
    conversation_history = []
    
    print(f"\nScene: {test_input.get('scene_id')}")
