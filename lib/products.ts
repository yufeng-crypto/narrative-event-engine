...
export const PRODUCTS: ProductConfig[] = [
  ...
  // ════════════════════════════════════════════════════════
  // 🆕 v0.8 Top 5 扩池新增 — 7 只 watch（Doubao+SearXNG+Jina 评估，2026-05）
  // ════════════════════════════════════════════════════════
  {
    code: '180201',
    name: '平安广州广河 REIT',
    ...
    tierReason: 'Top 5 扩池新增。量化得分 64（同类最高），但特许权 11 年偏短',
    ttmDividend: 0.73,
    ttmDividendAsOf: '2026-05-05',
    watchYield: 7.5,
    buyYield: 8.5,
    notes: '广河高速公路广州段。平安基金管理 + 广州交投。月度分红，2024 全年合计 0.73 元/份',
  },
  {
    code: '508018',
    name: '华夏中国交建 REIT',
    ...
    tierReason: 'Top 5 扩池新增。grade B- 边缘，超额分配 + 大额减值是主要扣分点',
    ttmDividend: 0.3165,
    ttmDividendAsOf: '2026-05-05',
    watchYield: 6.5,
    buyYield: 7.5,
    notes: '嘉通高速。华夏基金 + 中国交建。月度分红 5 次/12 月',
  },
  {
    code: '508000',
    name: '华安张江产业园 REIT',
    ...
    tierReason: 'Top 5 扩池新增。Phase 2 找到超额分配 + 估值下跌严重 red flags',
    ttmDividend: 0.1174,
    ttmDividendAsOf: '2026-05-05',
    watchYield: 5.5,
    buyYield: 6.5,
    notes: '张江光大园 + 张润大厦（上海浦东盛夏路）。华安基金 + 张江集团。2021-06 上市',
  },
  {
    code: '180101',
    name: '博时蛇口产园 REIT',
    ...
    tierReason: 'Top 5 扩池新增。grade C+ 偏低，可分配大幅下滑是主要扣分。Phase 2 因 seed bug abort，用 Phase 1 结论',
    ttmDividend: 0.083,
    ttmDividendAsOf: '2026-05-05',
    watchYield: 5.5,
    buyYield: 6.5,
    notes: '深圳蛇口万融大厦 + 万海大厦 + 光明加速器二期。博时基金 + 招商蛇口。2021-06 上市',
  },
  {
    code: '508021',
    name: '国泰海通临港创新产业园 REIT',
    shortName: '临港创新产业园',
    market: 'sh',
    category: 'reit',
    tier: 'watch',
    ...
    tierReason: 'Top 5 扩池新增。3 个标的（临港奉贤智造园 + 漕河泾康桥）资产质量好，但租户集中 + 大量租约到期是中期风险',
    ttmDividend: 0.1144,
    ttmDividendAsOf: '2026-05-05',
    watchYield: 5.0,
    buyYield: 5.8,
    notes: '临港奉贤智造园一二期 + 漕河泾康桥科技绿洲。国泰海通资管 + 临港集团',
  },
  {
    code: '180303',
    name: '华泰宝湾物流 REIT',
    ...
    tierReason: 'Top 5 扩池新增。3 个物流园资产 OK，但年底巨量解禁 + 租约集中到期是双重短期风险',
    ttmDividend: 0.1833,
    ttmDividendAsOf: '2026-05-05',
    watchYield: 5.5,
    buyYield: 6.5,
    notes: '天津宝湾 + 南京宝湾 + 嘉兴高标物流园。华泰证券资管 + 宝湾物流',
  },
  {
    code: '508002',
    name: '华安百联消费 REIT',
    ...
    tierReason: 'Top 5 扩池新增。出租率 95%/收缴率 98.66% 数据好，但 2.48 年剩余租期 + 解禁是双重隐患',
    ttmDividend: 0.1067,
    ttmDividendAsOf: '2026-05-05',
    watchYield: 5.0,
    buyYield: 5.8,
    notes: '上海又一城购物中心（五角场商圈）。华安基金 + 上海百联。2024-08 上市',
  },
];
